...
<form action="../collection/headBE.php" method="post">
<div class="card">
    <div class="card-header text-center">
        Details about the head/owner
    </div>
    <div class="mx-3 mt-3">
        <label class="form-label" for="name">Name:</label>
        <input class="form-control" type="text" name="name" id="name" placeholder="Enter name of the head of the family">
    </div>

    <div class="mx-3 my-1">
        <label class="form-label" for="name">Gender:</label>
        <!-- DROPDOWN -->
        <input class="form-control" type="text" name="gender" id="gender" placeholder="Enter the gender">
    </div>
    ...
    <div class="mx-3 my-1">
        ...
        <input class="form-control" type="text" name="dob" id="dob" placeholder="Enter date of birth">
    </div>
    ...
    <div class="mx-3 my-1">
        ...
        <!-- DROPDOWN -->
        <input class="form-control" type="text" name="employment" id="employment" placeholder="Enter employment">
    </div>
