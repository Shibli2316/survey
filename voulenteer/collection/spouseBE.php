...
if($_SERVER['REQUEST_METHOD']=="POST"){
    ...
    $sql = "INSERT INTO `spouse` (`name`, `gender`, `age`, `dob`, `qualification`, `employment`, `phone`, `aadhar`, `otherID`, `idNum`) VALUES ('$name', '$gender', '$age', '$dob', '$qual', '$employment', '$phone', '$aadhar', '$oID', '$oIDnum');";
